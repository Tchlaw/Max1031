...
### 4. You’re Cleaning Up Entity Structure or Partner Dynamics

Sometimes the real driver isn’t the building — it’s the cap table.

If you:

- Want out of a messy partnership,
- Want to simplify ownership into a new structure (e.g., a new LLC, trust, or family entity),
- Or want to align your portfolio for future 1031s, 721 UPREIT moves, or estate planning,

then hitting “reset” on basis while you reorganize can be a feature, not a bug.
